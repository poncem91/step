...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeNotAvail() {
    //
    // Events  :       |--A--|     |--B--|
    //         : |--------------C--------------| (optional attendee)   
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeAvail() {
    //
    // Events  :       |--A--|     |--B--|
    //         :             |--C--|          (optional attendee)   
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeNotEnoughTime() {
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|               (optional attendee)
    // Day     : |---------------------|
  ...
  @Test
  public void onlyOptionalAttendeesWithoutGaps() {
    //
    // Events  : |---A---||---B---|     (optional attendees)
    // Day     : |----------------|
    // Options : 
